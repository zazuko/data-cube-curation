...
export const OP_PROJECTS_GET = expand('dataCube:api/GetDataCubeProjects')
...
export const OP_SOURCE_GET = expand('dataCube:api/GetDataCubeSource')
export const OP_SOURCE_DELETE = expand('dataCube:api/DeleteSource')
export const OP_TABLES_GET = expand('dataCube:api/GetTables')
...
export const OP_TABLE_GET = expand('dataCube:api/GetTable')
